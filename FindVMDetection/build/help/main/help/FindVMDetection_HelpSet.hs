...
<!-- HelpSet auto-generated on Tue Apr 20 22:01:51 CEST 2021 -->
<helpset version="2.0">
	<title>FindVMDetection HelpSet</title>
	<maps>
		<mapref location="FindVMDetection_map.xml" />
	</maps>
	<view mergetype="javax.help.UniteAppendMerge">
		<name>TOC</name>
		<label>Ghidra Table of Contents</label>
		<type>docking.help.CustomTOCView</type>
		<data>FindVMDetection_TOC.xml</data>
	</view>
	<view>
		<name>Search</name>
		<label>Search for Keywords</label>
		<type>docking.help.CustomSearchView</type>
		<data engine="com.sun.java.help.search.DefaultSearchEngine">FindVMDetection_JavaHelpSearch</data>
	</view>
	<view>
		<name>Favorites</name>
